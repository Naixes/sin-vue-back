...
<script>
    ...
    import SContent from './layout/content'
    import SFooter from './layout/footer'
    import SToast from './toast'
    import STabs from './tabs'
    import STabsHeader from './tabs/tabsHeader'
    import STabsItem from './tabs/tabsItem'
    import STabsBody from './tabs/tabsBody'
    import STabsPanel from './tabs/tabsPanel'
    import SPopover from './popover'
    import SCollapse from './collapse'
    import SCollapseItem from './collapse/collapseItem'
    import SCascader from './cascader'
	import SCascaderItem from './cascader/cascaderItem'
    import SSlides from './slides'
	import SSlidesItem from './slides/slidesItem'
    import SNav from './nav'
	import SNavItem from './nav/navItem'
	import SSubNav from './nav/subNav'
	import SPager from './pager'
	import STable from './table'
	import SFormRow from './form/form-row'
